...
<!-- <nav>
  <div class="wrapper">
    <div class="logo"><a href="#">
        <img src="<?php echo base_url(); ?>img/logo.png" alt="Logo Madex" height="75px" width="220px"  style="margin-top: 20px;"   >
    </a></div>
    ...
    <ul class="nav-links">
      ...
      <li><li><a href="<?php echo base_url(); ?>index.php/web/producto ">
        Productos</a></li></li>
      <li>
